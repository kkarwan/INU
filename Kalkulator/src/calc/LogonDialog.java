...
public class LogonDialog extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		lblEnv = new Label("Œrodowisko:");
		lblUsers = new Label("U¿ytkownik:");
		...
		cbxUsers.setPromptText("Wybierz u¿ytkownika ...");
		...
		dialog.setResultConverter(dialogButton -> {
			...
			result.ifPresent(passField -> {
				System.out.println("U¿ytkownik = " + cbxUsers.getValue() + ", Has³o = " + passField.getValue());
			});
	}
